...
import heroVideo from '../assets/hero video/Neeraj-hero.mp4';
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden bg-black">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-black/25 pointer-events-none" />
      </div>
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <p 
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-white text-sm md:text-lg font-semibold mb-8 max-w-lg drop-shadow-md leading-relaxed"
          >
